...
if (isset($_POST['update_order'])) {
   ...
   // Check if both values are provided before updating
   if (!empty($order_id) && !empty($update_payment)) {
      ...
      <div class="box">
         ...
         <form action="" method="POST">
            ...
            <select name="update_payment" class="drop-down" required>
               <option value="<?= htmlspecialchars($fetch_orders['payment_status']); ?>" selected disabled>
            ...
            <div class="flex-btn">
               ...
               <a href="admin_orders.php?delete=<?= htmlspecialchars($fetch_orders['id']); ?>" 
                  class="delete-btn" 
